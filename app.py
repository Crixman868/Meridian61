...
# Safety Wrapper for Data Writes
...
# ... [PASTE YOUR EXISTING HELPER FUNCTIONS: get_gspread_client, get_drive_service, load_log_data, save_log_data, upload_system_pdf_to_drive, upload_physical_file_to_drive, get_eta_status, get_img_b64, get_entity_profile, get_supplier_mapping, save_supplier_mapping, generate_html_document, create_print_button, display_html_preview] ...
...
# ==========================================
# 3. RENDER FUNCTIONS (MASTER LOG & TRACKER)
# ==========================================
# [PASTE YOUR EXISTING render_master_log AND render_admin_tracker HERE]
# IMPORTANT: In your save_log_data logic inside render_master_log, use the safe_update_log function:
# Example: 
