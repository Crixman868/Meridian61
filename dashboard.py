...
def render_staff_dashboard():
    ...
    # 1. Timeline Status Logic (using your original get_eta_status)
    ...
    # 2. Visual Transformation (Links to Checked Boxes)
    ...
    st.dataframe(df_display.style.apply(style_dashboard, axis=1), use_container_width=True)
