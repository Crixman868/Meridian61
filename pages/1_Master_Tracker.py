...
def upload_system_pdf_to_drive(html_content, file_name, client_name, invoice_no):
    ...
    try:
        ...
        # 3. NATIVE CONVERSION: Upload HTML and tell Google to parse it as a Google Doc
        with tempfile.NamedTemporaryFile(delete=False, suffix=".html", mode='w', encoding='utf-8') as temp_html:
            temp_html.write(html_content)
            temp_html_path = temp_html.name
            
        doc_metadata = {'name': f"temp_render_{file_name}", 'parents': [inv_folder_id], 'mimeType': 'application/vnd.google-apps.document'}
            ...
            if client_name != "Select a Client..." and supplier_name != "Select a Supplier...":
                with st.spinner("Locking PDFs and Syncing to Master Log..."):
                    try:
                        ...
                        # 2. Upload, Convert, and Save Links
